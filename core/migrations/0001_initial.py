    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Admin'), ('outlet', 'Outlet')], default='outlet', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outlet', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='summary', to='core.outlet')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('transaction_type', models.CharField(choices=[('payment', 'Payment'), ('topup', 'Top-up')], max_length=10)),
